                    ...
                    <Row>
                        <Col md={12} className="mb-3">
                            <Form.Group id="username">
                                ...
                                <Form.Control required type="text" placeholder="My Username"></Form.Control>
                            </Form.Group>
                        </Col>
                        <Col md={12} className="mb-3">
                            <Form.Group id="password">
                                <Form.Label>Old Password</Form.Label>
                                <Form.Control required type="password" placeholder="My Old Password"></Form.Control>
                            </Form.Group>
                        </Col>
                        <Col md={12} className="mb-3">
                            <Form.Group id="password_confirm">
                                <Form.Label>New Password</Form.Label>
                                <Form.Control required type="password" placeholder="New password"></Form.Control>
                            </Form.Group>
                        </Col>
                        <Col md={12} className="mb-3">
                            <Form.Group id="password_confirm">
                                <Form.Label>Confirm New Password</Form.Label>
                                <Form.Control required type="password" placeholder="Confirm new password"></Form.Control>
                            </Form.Group>
                        </Col>
                        <Col md={12} className="mb-3">
